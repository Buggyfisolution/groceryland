...
class AppConfig {
  static String copyright_text = "@ groceryland " + this_year; //this shows in the splash screen
  static String app_name = "groceryland"; //this shows in the splash screen
  static String purchase_code = "db7cf6fb-e23d-4df2-92de-0492dd12accf"; //enter your purchase code for the app from codecanyon
  ...
  //configure this
  static const DOMAIN_PATH = "groceryland.in"; //localhost
